...
const Experience = () => {
  const hac = useRef(0), int = useRef(1), edu = useRef(2);
  const internExp = [
    {
  ...
  const hackExp = [
    {
        "desig": "Devjam",
        "date": "May 2023",
        "company": "Script Foundation | Devfolio",
  ...
  const eduExp = [
    {
        "desig": "Computer Science Engineering",
    ...
    },
    {
        "desig": "12 standard",
        "date": "2021-2022",
        "company": "CBSE: Parama Bhattara Kendriya Vidyalayam",
        "content": "Percentage: 96.4%"
    },
    {
        "desig": "10 standard",
        "date": "2019-2020",
    ...
    <section className="exp" id="experience">
        <header>
            <h2 ref={int} className="active" onClick={() => {
                ...
                edu.current.classList.remove("active");
                }}>
            ...
            <h2 ref={edu} onClick={() => {
                ...
                hac.current.classList.remove("active");
                int.current.classList.remove("active");
                edu.current.classList.add("active");
                }}>
        ...
        <div className="container">
            <div className="card">
                { display.map( exp => <Expdetails key={exp["date"]} desig={exp["desig"]} date={exp["date"]} company={exp["company"]} content={exp["content"]}/> ) }
            </div>
